...
/** Dashed square + pointer — element select toggle (Lucide square-dashed-mouse-pointer) */
export function IconSelectElement(p: IconProps) {
  return (
    <Ic {...p}>
...
/** 🐞 bug / Chrome DevTools / debug inspector (Lucide bug) */
...
export function IconLayoutSidebar(p: IconProps) {
  return (
    <Ic {...p}>
