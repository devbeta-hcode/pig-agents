...
- "browser_navigate"  input: { "url": "https://..." }  — Drive the embedded Playwright Chromium (the Browser panel UI). Use this *instead of* web_fetch when the page needs JavaScript to render (SPAs, dashboards, login flows, dev servers you just started, anything where view-source is empty). Auto-launches the browser on first call. Same approval gate as web_fetch.
